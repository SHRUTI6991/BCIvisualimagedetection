...
for i=1:num_of_training_data_files
   ...
   if(strcmp('f',lower(fileName(1))))
       trainingData_features(i,31) = 1; % familiar stimulus
   else
       trainingData_features(i,31) = 0;
   end
end
